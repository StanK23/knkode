		...
		<div className="flex items-end bg-sunken border-b border-edge relative shrink-0">
			...
			{appState.activeWorkspaceId && (
				<button
					...
					className="bg-transparent border-none text-content-muted cursor-pointer text-xl px-3 h-tab flex items-center shrink-0 hover:text-content hover:bg-overlay rounded-sm focus-visible:ring-1 focus-visible:ring-accent focus-visible:outline-none"
					style={{ WebkitAppRegion: 'no-drag' }}
				>
					&#9881;
				</button>
