		...
		>
			...
			{branch && (
				<output
					...
					className="min-w-0 text-[10px] font-medium px-2 py-px rounded-sm overflow-hidden text-ellipsis whitespace-nowrap"
					title={branch}
					style={{
			...
			{pr && (
				<button
					...
					className={`text-[10px] font-medium px-2 py-px rounded-sm cursor-pointer border-none opacity-40 hover:opacity-80 transition-opacity ${FOCUS_VIS}`}
					style={{
						backgroundColor: `${theme.accent}18`,
						color: theme.accent,
					}}
