...
export function App() {
	...
	// Toggle Electron vibrancy (macOS) / backgroundMaterial (Windows) based on blur setting.
	// Vibrancy is binary — CSS masking layer in Terminal.tsx handles level simulation.
